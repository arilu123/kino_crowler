...
SPA-устойчивые якоря см. в `extension/content.js` и таблице ниже.
...
Классический формат (st.kp.yandex.net), не Next.js. Парсер: `extractBox()` в content.js → `/box` → `film_box`.
