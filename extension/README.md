...
3. **Крауль**: ходи по сайту. Расширение работает на **всех** страницах kinopoisk.ru.
   ...
   - **Панель** (правый низ): сверху — очередь новых фильмов (кликабельные `#id — Название`,
     можно сразу перейти); посередине — оранжевая плашка `🆕 новые атрибуты: …`, если на этом
     фильме впервые встретился неизвестный атрибут; снизу — статус: `✓ #id записан` / `↻ #id обновлён`.
